...
declare function b32_buf(b32: ArrayBufferView, overwrite?: true | undefined): Uint8Array;
declare function b32_buf(b32: string, overwrite?: boolean): Uint8Array;
declare function b32_buf(b32: string, overwrite?: true): never;

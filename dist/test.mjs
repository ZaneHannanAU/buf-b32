...
rt();
test(b32);
const b32Decoded = decode(b32), back = Buffer.from(b32Decoded.buffer, b32Decoded.byteOffset, b32Decoded.byteLength);
rt();
test(back);
...
rt();
test(rndb32);
const rndb32Decoded = decode(rndb32), rndback = Buffer.from(rndb32Decoded.buffer, rndb32Decoded.byteOffset, rndb32Decoded.byteLength);
rt();
